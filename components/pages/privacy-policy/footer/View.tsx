...
export function PrivacyPolicyFooterView({ data }: FooterViewProps) {
    return (
                        ...
                        <div className='flex gap-4'>
                            {
                                data.social.map((item, idx) => {
                                    ...
                                    return (
                                        <Link href={item.url} className='bg-lightblue hover:bg-white transition-colors rounded-full px-2 py-2 flex items-center justify-center' key={idx}>
                        ...
                        <div className='flex flex-col gap-3'>
                            {
                                data.resources.map((item, idx) => {
                                    return (
                                        <Link href={item.url} key={idx} className='flex flex-col gap-1 text-md text-white'>
                                            <span className='font-medium'>{item.name}</span>
                                        </Link>
                                    )
                                })
                        ...
                        <div className='flex flex-col gap-3'>
                            {
                                data.company.map((item, idx) => {
                                    return (
                                        <Link href={item.url} className='flex flex-col gap-1 text-md text-white' key={idx}>
                                            <span className='font-medium'>{item.name}</span>
                                        </Link>
                                    )
                                })
