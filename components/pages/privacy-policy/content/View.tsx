...
export function PrivacyPolicyContentView({ data }: PrivacyPolicyContentViewProps) {
    const DEFINITIONS = [
        ...
        {
            word: "Company",
            meaning: `(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to ${data.country_info}`
        },
        {
            word: "Cookies",
        ...
        {
            word: "Country",
            meaning: `refers to: ${data.country_info}`
        },
        {
            word: "Device",
        ...
        {
            word: "Website",
            meaning: `refers to Ears to You, accessible from ${data.website_info}`
        },
        {
            word: "You",
    ...
    return (
        <section className="relative min-h-[660px] flex items-center justify-center overflow-hidden bg-white">
            <div className="mx-auto flex flex-col items-start max-w-7xl justify-between px-6 py-12 sm:py-16 lg:px-8 gap-8" aria-label="Global">
                <div className="flex flex-col text-darkblue gap-6">
                ...
                <div className="">
                    ...
                    <div className="flex flex-col gap-6 mt-6">
                        <div className="flex flex-col gap-5">
                            ...
                            <p className="text-base">The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                        </div>
                        <div className="flex flex-col gap-5">
                            <h2 className="text-2xl font-semibold">Definitions</h2>
                            <div className="flex flex-col gap-4">
                                <h6 className="text-base">For the purposes of this Privacy Policy:</h6>
                                <ul className="flex flex-col gap-4 list-disc" >
                                    {
                                        DEFINITIONS.map((item, idx) => {
                                            return (
                                                <li className="ml-8 text-base" key={idx}>
                                                    <p><b>{item.word} </b>{item.meaning}</p>
                                                </li>
                                            )
                                        })
                                    }
                ...
                <div className="">
                    <h1 className="text-3xl font-bold">Collecting and Using Your Personal Data</h1>
                    <div className="flex flex-col gap-6 mt-6">
                        <div className="flex flex-col gap-5">
                                                ...
                                                return (
                                                    <li className="ml-8">
                                                        <div className="flex flex-col gap-3" key={idx}>
                                                            ...
                                                            <span>Administrated By: {item.administrated_by}</span>
                        ...
                        <div className="">
                            ...
                            <div className="flex flex-col gap-4 mt-6">
                                <h6 className="text-base">The Company may use Personal Data for the following purposes:</h6>
                                <ul className="flex flex-col gap-4 list-disc" >
                                    {
                                        [
                                            {
                                            ...
                                            return (
                                                <li className="ml-8 text-base" key={idx}>
                                                    <p><b>{item.term} </b>{item.content}</p>
                                                </li>
                                            )
                                        })
                                    }
                            ...
                            <div className="flex flex-col gap-4 mt-6">
                                <h6 className="text-base">We may share Your personal information in the following situations:</h6>
                                <ul className="flex flex-col gap-4 list-disc" >
                                    {
                                        [
                                            {
                ...
                <div className="">
                    <h1 className="text-3xl font-bold">Links to Other Websites</h1>
                    <div className="flex flex-col gap-5 mt-6">
                        {
                            [
                ...
                <div className="">
                    <h1 className="text-3xl font-bold">Changes to this Privacy Policy</h1>
                    <p className="my-6">If you have any questions about this Privacy Policy, You can contact us:</p>
