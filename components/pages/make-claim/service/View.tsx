...
interface HearingTestsServiceViewProps {
    data: ServicesData
}


export function HearingTestsServiceView({ data }: HearingTestsServiceViewProps) {
    return (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className='flex flex-col gap-6 flex-1 lg:justify-center items-center'>
                                        <h2 className='text-lg md:text-2xl w-full lg:text-left text-center lg:text-3xl font-black text-darkblue'>{item.title}</h2>
